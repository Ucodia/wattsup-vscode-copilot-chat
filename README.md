...
```
wget https://github.com/Ucodia/wattsup-vscode-copilot-chat/releases/download/99.0.0/wattsup-copilot-chat-99.1.0.vsix
code --install-extension wattsup-copilot-chat-99.1.0.vsix
```